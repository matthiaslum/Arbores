...
Parbores is a parallel implementation of Arbores; a Markov chain Monte Carlo (MCMC) algorithm for simulating ancestral
...
2. Ensure that you have **7 cores** on the same node; connected by *Infiniband*. (Best to remotely access high performance computing center)
...
**mpirun -np 7 ./Parbores arb_data4.txt 20000 1e-8 0.001 1 output_file**

The above line executes Parbores with 7 cores. It is run for 20,000 iterations, with mutation and recombination rates of 1e-8 and 0.001 respectively. The random seed is 1, and the results are stored in *output_file*. 
